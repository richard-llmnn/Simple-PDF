...
async function handleJpeg(file) {
    ...
    const imageDimensions = await getHeightAndWidthFromImage(URL.createObjectURL(file));
    const page1Temp = tempFile.addPage([imageDimensions.width, imageDimensions.height]);
